...
function Project() {
  const projects = [
    ...
    },
    {
      ...
      tech: ["Node.js", "Dialogflow", "MongoDB"],
      githublink: "/",
      desc: [
        "💻 Built a responsive chatbot interface that fits right into customer service platforms.",
        "🎞️ Mapped out smooth conversation flows to keep chats clear and helpful.",
        "⌨️ Used NLP to help the bot understand user questions and give accurate answers.",
        "🎨 Focused on front-end design to make interactions easy and user-friendly.",
  ...
  return (
    <>
      <div className="w-[85%] mx-auto text-left mt-2 pt-2">
        ...
        <div
          className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 pb-4 pt-2 "
